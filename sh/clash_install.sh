...
function install_subweb() {
  ...
  if [[ $? -ne 0 ]];then
    ...
    wget -q https://ghproxy.com/https://raw.githubusercontent.com/shidahuilang/SS-SSR-TG-iptables-bt/main/Subconverter.vue -O /root/sub-web/src/views/Subconverter.vue
    if [[ $? -ne 0 ]]; then
      curl -fsSL https://cdn.jsdelivr.net/gh/shidahuilang/SS-SSR-TG-iptables-bt@main/Subconverter.vue > "/root/sub-web/src/views/Subconverter.vue"
    fi
    rm -fr "subweb"
    cd "sub-web"
